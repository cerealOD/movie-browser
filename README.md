...
There is also a search feature where users can search for movies by typing to the search bar, with live search results being displayed under. The app returns search results from TMBD and they are displayed with pagination.
